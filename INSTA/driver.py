...
chromedriver_path = 'C:/Users/VikramSingh/Downloads/chromedriver.exe' # Change this to your own chromedriver path!
...
username.send_keys('love_2photography')
password = webdriver.find_element_by_name('password')
password.send_keys('Photography@2020')
...
hashtag_list = ['travelblog', 'photoshoot','photography','mobilephotography','photos','nightphotos']
        ...
        for x in range(1,200):
            ...
            if username not in prev_user_list:
                ...
                if webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/header/div[2]/div[1]/div[2]/button').text == 'Follow':
                    ...
                    # Liking the picture
                    button_like = webdriver.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/div[3]/section[1]/span[1]/button/div/span/svg')
